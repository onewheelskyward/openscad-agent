// Coffee Table Caddy — v016
// v015, but the whole back-row trio is shifted 6mm left to center it between
// the side walls (was ~16mm left / ~3.8mm right; now ~10mm each side). The
// round and the 29x31 slot each get -6 on their x-offset and the floss, being
// derived from the round, follows; the 15mm gaps are preserved.
//
