...
/* [Per-hole layout] */
cells = [
    // front row: glass well, upright remote slot, and a double-length
    // magazine/tablet slot spanning both rows (note span_rows = 2)
    [ ["r", 85, 85],      ["s", 30, 85],  ["s", 30, 139, 65, 1, 2] ],
    // back row: shallow coaster tray, pen cup; last cell covered by the span
    [ ["s", 85, 50, 25],  ["r", 30, 30],  ["-"] ]
];
