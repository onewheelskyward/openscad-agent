// Coffee Table Caddy — v012
// v011, but the vertical rhythm is evened out. v011 had a dead ~20mm empty
// strip at the front edge while the rows were jammed at 4mm walls. v012 drops
// the front strip (extra_length=0) and introduces row_gap: a larger, uniform
// gap between rows so the toothbrush, round, and floss/back rows are evenly
// spaced front-to-back. Overall length is preserved (~206mm).
//
...
/* [Body] */
wall    = 4;         // outer wall + horizontal gap between columns
