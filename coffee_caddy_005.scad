...
/* [Per-hole layout] */
cells = [
    // row 1: 34x36 slot | 70x102 slot spanning rows 1-2
    [  ["s", 70, 102, 65, 1, 2], ["s", 34, 36]],
    // row 2: 66x32 slot | covered by the span above
    [ ["-"], ["s", 66, 32] ],
    // row 3: 61x35 slot | 35mm round
    [ ["r", 35, 35], ["s", 61, 35] ],
    // row 4: 29x31 slot | 35mm round
    [ ["r", 35, 35], ["s", 29, 31] ]
];
...
/* [Extras] */
drain_d = 10;         // drain hole diameter per pocket (0 = none)
