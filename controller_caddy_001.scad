...
/* [Per-hole layout] */
cells = [
    // col 1: the four parametric slots | col 2: DualSense dogbone slot
    //        spanning all four rows (44mm grip wells, 168mm long, 55 deep)
    [ ["s", 34, 36],  ["p", 44, 168, 55, 1, 4] ],
    [ ["s", 66, 32],  ["-"] ],
    [ ["s", 61, 35],  ["-"] ],
    [ ["s", 29, 31],  ["-"] ]
];
